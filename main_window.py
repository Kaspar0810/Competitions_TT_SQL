...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Button_title_edit.setGeometry(QtCore.QRect(19, 40, 141, 40))
        font = QtGui.QFont()
        font.setFamily("Courier New")
        self.Button_title_edit.setFont(font)
        ...
        self.checkBox_edit = QtWidgets.QCheckBox(self.page)
        self.checkBox_edit.setGeometry(QtCore.QRect(170, 50, 21, 20))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.checkBox_edit.setText(_translate("MainWindow", "CheckBox"))
