...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.frame_main.setGeometry(QtCore.QRect(10, 505, 180, 114))
        ...
        self.frame_table.setGeometry(QtCore.QRect(200, 250, 821, 371))
        ...
        self.toolBox.setGeometry(QtCore.QRect(10, 0, 180, 430))
        self.toolBox.setMinimumSize(QtCore.QSize(180, 430))
        self.toolBox.setMaximumSize(QtCore.QSize(180, 430))
        font = QtGui.QFont()
        ...
        self.page.setGeometry(QtCore.QRect(0, 0, 178, 224))
        self.page.setObjectName("page")
        self.Button_title_made = QtWidgets.QPushButton(self.page)
        self.Button_title_made.setGeometry(QtCore.QRect(10, 0, 150, 30))
        self.Button_title_made.setAutoDefault(False)
        self.Button_title_made.setDefault(True)
        self.Button_title_made.setFlat(False)
        self.Button_title_made.setObjectName("Button_title_made")
        self.Button_title_edit = QtWidgets.QPushButton(self.page)
        self.Button_title_edit.setGeometry(QtCore.QRect(10, 30, 150, 30))
        self.Button_title_edit.setObjectName("Button_title_edit")
        self.toolBox.addItem(self.page, "")
        self.page_2 = QtWidgets.QWidget()
        self.page_2.setGeometry(QtCore.QRect(0, 0, 178, 224))
        ...
        self.page_6.setGeometry(QtCore.QRect(0, 0, 178, 224))
        self.page_6.setObjectName("page_6")
        self.toolBox.addItem(self.page_6, "")
        self.page_3 = QtWidgets.QWidget()
        self.page_3.setGeometry(QtCore.QRect(0, 0, 178, 224))
        self.page_3.setObjectName("page_3")
        self.toolBox.addItem(self.page_3, "")
        self.page_5 = QtWidgets.QWidget()
        self.page_5.setGeometry(QtCore.QRect(0, 0, 178, 224))
        self.page_5.setObjectName("page_5")
        self.toolBox.addItem(self.page_5, "")
        self.page_4 = QtWidgets.QWidget()
        self.page_4.setGeometry(QtCore.QRect(0, 0, 178, 224))
        self.page_4.setObjectName("page_4")
        self.toolBox.addItem(self.page_4, "")
        self.tabWidget = QtWidgets.QTabWidget(self.centralwidget)
        self.tabWidget.setGeometry(QtCore.QRect(200, 0, 821, 241))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        ...
        self.tableWidget.setGeometry(QtCore.QRect(210, 261, 801, 351))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(12)
        font.setItalic(True)
        ...
        self.frame_score.setMaximumSize(QtCore.QSize(400, 16777215))
        ...
        self.tableWidget_R_list.setGeometry(QtCore.QRect(210, 260, 801, 351))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(14)
        font.setItalic(True)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Button_title_edit.setText(_translate("MainWindow", "Редактировать"))
