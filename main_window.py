...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.frame_main.setGeometry(QtCore.QRect(10, 450, 171, 101))
        ...
        self.page.setGeometry(QtCore.QRect(0, 0, 169, 174))
        ...
        self.page_2.setGeometry(QtCore.QRect(0, 0, 169, 174))
        ...
        self.page_3.setGeometry(QtCore.QRect(0, 0, 169, 174))
        self.page_3.setObjectName("page_3")
        self.toolBox.addItem(self.page_3, "")
        self.page_5 = QtWidgets.QWidget()
        self.page_5.setGeometry(QtCore.QRect(0, 0, 169, 174))
        self.page_5.setObjectName("page_5")
        self.toolBox.addItem(self.page_5, "")
        self.page_4 = QtWidgets.QWidget()
        self.page_4.setGeometry(QtCore.QRect(0, 0, 169, 174))
        self.page_4.setObjectName("page_4")
        self.toolBox.addItem(self.page_4, "")
        self.tabWidget = QtWidgets.QTabWidget(self.centralwidget)
        self.tabWidget.setGeometry(QtCore.QRect(190, 0, 601, 231))
        font = QtGui.QFont()
        ...
        self.lineEdit_titul_nazvanie.setGeometry(QtCore.QRect(20, 30, 571, 21))
        ...
        self.lineEdit_titul_vozrast.setGeometry(QtCore.QRect(330, 70, 261, 21))
        ...
        self.label_2str_4.setGeometry(QtCore.QRect(390, 100, 161, 16))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(12)
        font.setItalic(True)
        ...
        self.lineEdit_city = QtWidgets.QLineEdit(self.tab)
        self.lineEdit_city.setGeometry(QtCore.QRect(420, 120, 171, 21))
        self.lineEdit_city.setObjectName("lineEdit_city")
        self.label_city = QtWidgets.QLabel(self.tab)
        self.label_city.setGeometry(QtCore.QRect(350, 120, 60, 16))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(12)
        font.setItalic(True)
        ...
        self.comboBox_kategor_sek.setGeometry(QtCore.QRect(500, 170, 91, 26))
        ...
        self.lineEdit_sekretar.setGeometry(QtCore.QRect(300, 170, 191, 21))
        ...
        self.lineEdit_refery.setGeometry(QtCore.QRect(20, 170, 176, 21))
        self.lineEdit_refery.setObjectName("lineEdit_refery")
        self.label_kat_ref = QtWidgets.QLabel(self.tab)
        self.label_kat_ref.setGeometry(QtCore.QRect(210, 150, 81, 16))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(12)
        font.setItalic(True)
        ...
        self.comboBox_kategor_ref.setGeometry(QtCore.QRect(200, 170, 91, 26))
        self.comboBox_kategor_ref.setObjectName("comboBox_kategor_ref")
        self.tabWidget.addTab(self.tab, "")
        self.tab_1 = QtWidgets.QWidget()
        self.tab_1.setObjectName("tab_1")
        self.lineEdit_Find_Rlist = QtWidgets.QLineEdit(self.tab_1)
        self.lineEdit_Find_Rlist.setGeometry(QtCore.QRect(10, 30, 271, 21))
        self.lineEdit_Find_Rlist.setObjectName("lineEdit_Find_Rlist")
        self.pushButton_find = QtWidgets.QPushButton(self.tab_1)
        self.pushButton_find.setGeometry(QtCore.QRect(350, 30, 113, 32))
        ...
        self.tableWidget.setGeometry(QtCore.QRect(200, 261, 581, 171))
        self.tableWidget.setObjectName("tableWidget")
        self.tableWidget.setColumnCount(0)
        self.tableWidget.setRowCount(0)
        self.listWidget = QtWidgets.QListWidget(self.centralwidget)
        self.listWidget.setGeometry(QtCore.QRect(490, 441, 291, 101))
